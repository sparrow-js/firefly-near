...
class KeybindingService {
  ...
  constructor() {
    ...
    this.currentDocument = engine.currentDocument;
    this.keybindingMap = [];
  }
  bind(kb: IKeyBinding) {
  ...
  private getSelectedNode() {
    const selectedNodeId = this.currentDocument.selection.selected[0];
    return selectedNodeId ? this.currentDocument.nodesMap.get(selectedNodeId) : null;
  }
